...
const parser =  (ActionMetaData:string,zapMetaData:any,startDelimeter = "{" ,endDelimeter = "}" )=>{
...
// async..await is not allowed in global scope, must use a wrapper
 async function sendGmail( from :string,to:string,body:string,subject:string ) {
...
export const processEmail = async (ActionMetaData:any,zapMetaData:any) =>{
    // console.log("action meta data",ActionMetaData)
    // console.log("action meta data from",ActionMetaData.from)

    const from = parser(ActionMetaData.from as string,zapMetaData)
    const to = parser(ActionMetaData.to as string,zapMetaData)
    const subject = parser(ActionMetaData.subject as string,zapMetaData)
    const body = parser(ActionMetaData.body as string,zapMetaData)
